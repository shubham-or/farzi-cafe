...
public class RoomDetails
{
    ...
    public bool IsGameCompleted() => userData.All(item => item.Value.hasCompleted);

    public bool IsRoomFull() => MemberIds.Count == MaxPlayers;

    public int GetPlayersCount() => userData.Count;
